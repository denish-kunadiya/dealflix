...
const ordersFeedPath = '/orders';
const myOrdersPath = '/orders/my';
...
const AppNavbar = () => {
  ...
  const navigation = [
    ...
    { name: 'My Orders', href: myOrdersPath, current: path === myOrdersPath },
  ];
          ...
          <div className="mx-auto max-w-7xl px-6 sm:px-10">
            <div className="flex h-[60px] justify-between">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <button
                  type="button"
                  className="relative rounded-full bg-slate-50 p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
                >
